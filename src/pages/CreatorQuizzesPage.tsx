    ...
    <>
      <PageContainer className="!max-w-[1200px]">
        <div className="space-y-6 lg:space-y-7">
          ...
          {loading ? (
            <>
              {/* Desktop skeleton — mirrors table columns: dot+title+subtitle | price | badge | attempts | earnings | date | buttons */}
              <div className="hidden lg:block">
                <Card padded={false} className="overflow-hidden">
                  {/* Table header skeleton */}
                  <div className="flex items-center gap-4 px-5 py-3 border-b border-border/50 bg-surface/30">
                    <div className="h-3 w-48 rounded-md bg-surface animate-pulse" />
                    <div className="h-3 w-14 rounded-md bg-surface animate-pulse ml-auto" />
                    <div className="h-3 w-16 rounded-md bg-surface animate-pulse" />
                    <div className="h-3 w-14 rounded-md bg-surface animate-pulse" />
                  ...
                  <div className="divide-y divide-border/40">
                    {[0, 1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="flex items-center gap-4 pl-5 pr-5 py-3.5"
                        style={{ opacity: 1 - i * 0.15 }}
                      >
                        {/* dot + title col */}
                        <div className="flex items-start gap-2.5 flex-1 min-w-0">
                          <div className="mt-2 h-2 w-2 rounded-full bg-surface animate-pulse shrink-0" />
                          <div className="space-y-1.5 min-w-0 flex-1">
                            <div className="h-3.5 rounded-lg bg-surface animate-pulse w-3/4" />
                            <div className="h-3 rounded-md bg-surface/60 animate-pulse w-1/3" />
                          </div>
                        </div>
                        {/* price */}
                        <div className="h-3.5 w-14 rounded-lg bg-surface animate-pulse shrink-0" />
                        {/* status badge */}
                        <div className="h-6 w-20 rounded-xl bg-surface animate-pulse shrink-0" />
                        {/* attempts */}
                        <div className="h-3.5 w-8 rounded-lg bg-surface animate-pulse shrink-0 ml-auto" />
                        {/* earnings */}
                        <div className="h-3.5 w-16 rounded-lg bg-surface animate-pulse shrink-0" />
                        {/* date */}
                        <div className="h-3 w-20 rounded-md bg-surface/70 animate-pulse shrink-0" />
                        {/* action buttons */}
                        <div className="flex items-center gap-1.5 shrink-0">
                          <div className="h-8 w-14 rounded-xl bg-surface animate-pulse" />
                          <div className="h-8 w-22 rounded-xl bg-surface animate-pulse" />
              ...
              {/* Mobile skeleton — mirrors QuizMobileCard layout */}
                  ...
                  >
                    <div className="p-4 space-y-3 animate-pulse">
                      ...
                      <div className="flex items-start gap-2.5">
                        <div className="mt-1.5 h-2 w-2 rounded-full bg-surface shrink-0" />
                        <div className="flex-1 min-w-0 space-y-1.5">
                          <div className="h-4 rounded-lg bg-surface w-4/5" />
                          <div className="h-3 rounded-md bg-surface/60 w-1/3" />
                        </div>
                        <div className="h-6 w-20 rounded-xl bg-surface shrink-0" />
                      </div>
                      {/* stats row */}
                      <div className="flex items-center gap-4 pt-0.5">
                        <div className="h-3 w-16 rounded-md bg-surface/70" />
                        <div className="h-3 w-14 rounded-md bg-surface/70" />
                        <div className="h-3 w-20 rounded-md bg-surface/70" />
                      </div>
                      {/* action buttons row */}
